...
function (_Component) {
  ...
  _createClass(AnyOfField, [{
    ...
    value: function getMatchingOption(formData, options) {
      var _getUiOptions = (0, _utils.getUiOptions)(this.props.uiSchema),
      ...
      if (uiOptions.anyOfDiscriminatorField) {
        var selectedDiscriminatorValue = formData[uiOptions.anyOfDiscriminatorField];
        console.log(uiOptions.anyOfDiscriminatorField, selectedDiscriminatorValue, formData);
        var _iteratorNormalCompletion2 = true;
        var _didIteratorError2 = false;
        var _iteratorError2 = undefined;

        try {
          for (var _iterator2 = this.props.options.entries()[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
            var _opt, _opt$properties, _opt$properties$uiOpt, _opt$properties$uiOpt2;

            var _step2$value = _slicedToArray(_step2.value, 2),
                idx = _step2$value[0],
                _option2 = _step2$value[1];

            var opt = _option2;

            if (_option2.hasOwnProperty('$ref')) {
              opt = resolveSchema(_option2, rootSchema, formData);
            }

            if (((_opt = opt) === null || _opt === void 0 ? void 0 : (_opt$properties = _opt.properties) === null || _opt$properties === void 0 ? void 0 : (_opt$properties$uiOpt = _opt$properties[uiOptions.anyOfDiscriminatorField]) === null || _opt$properties$uiOpt === void 0 ? void 0 : (_opt$properties$uiOpt2 = _opt$properties$uiOpt["enum"]) === null || _opt$properties$uiOpt2 === void 0 ? void 0 : _opt$properties$uiOpt2[0]) === selectedDiscriminatorValue) {
    ...
    value: function render() {
      ...
      var _getUiOptions2 = (0, _utils.getUiOptions)(uiSchema),
          ...
          widget = _getUiOptions2$widget === void 0 ? "select" : _getUiOptions2$widget,
          uiOptions = _objectWithoutProperties(_getUiOptions2, ["widget"]);
      ...
      var enumOptions = options.map(function (option, index) {
        if (uiOptions.anyOfDiscriminatorField) {
          var _opt2, _opt2$properties, _opt2$properties$uiOp, _opt2$properties$uiOp2;
          ...
          console.log(opt);
          return {
            label: (_opt2 = opt) === null || _opt2 === void 0 ? void 0 : (_opt2$properties = _opt2.properties) === null || _opt2$properties === void 0 ? void 0 : (_opt2$properties$uiOp = _opt2$properties[uiOptions.anyOfDiscriminatorField]) === null || _opt2$properties$uiOp === void 0 ? void 0 : (_opt2$properties$uiOp2 = _opt2$properties$uiOp["enum"]) === null || _opt2$properties$uiOp2 === void 0 ? void 0 : _opt2$properties$uiOp2[0],
            value: index
          };
        } else return {
