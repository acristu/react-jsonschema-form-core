...
function (_Component) {
  ...
  _createClass(AnyOfField, [{
    ...
    value: function getMatchingOption(formData, options) {
      var _getUiOptions = getUiOptions(this.props.uiSchema),
      ...
      if (uiOptions.anyOfDiscriminatorField) {
        ...
        try {
          for (var _iterator2 = _getIterator(this.props.options.entries()), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
